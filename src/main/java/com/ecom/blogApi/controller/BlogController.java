...
public class BlogController {
	...
	ResponseEntity<Object> postBlogs(@RequestParam("categoryId") int categoryId,@RequestParam("authorName") String authorName ,@RequestParam("blogTitle") String blogTitle ,@RequestParam("description") String description,@RequestParam("seoTitle") String seoTitle,@RequestParam("seoMetaDescription") String seoMetaDescription,@RequestParam("status") String status,@RequestParam("imgData") MultipartFile imgData ,@RequestParam("bannerData") MultipartFile bannerData){
		try {
			Blog blog = blogService.createBlog(categoryId,authorName, blogTitle, description, seoTitle, seoMetaDescription, status,imgData ,bannerData);
